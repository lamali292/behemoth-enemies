...
* If Vulcanus surface lacks territory\_settings (due to other mods), Behemoth Demolishers will not spawn
...
* Fixed crash when Vulcanus has no territory\_settings
